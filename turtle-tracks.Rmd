...
The last section displays the currency of the data used here.
...
To use real-time data, data are loaded through the GFT API v2
...
# Infer observation locations through intersection
...
## Fresh tracks data, all locations
...
## Fresh tracks timeseries, Thevenard
...
**`r no_observations` observations retrieved on `r data_retrieved_on` GMT+08, latest
observation on `r latest_observation` GMT+08.**
